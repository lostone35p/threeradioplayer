...
Author: ParoxysmKing (https://sketchfab.com/ParoxysmKing)
License: CC-BY-4.0 (http://creativecommons.org/licenses/by/4.0/)
Source: https://sketchfab.com/3d-models/small-stage-e99ae4dc0a10431096712a63e21d7be5
Title: Small Stage
*/

// Maybe just use primitive objects instead of this gltfjsx stuff ?
...
type GLTFResult = GLTF & {
	...
	materials: {
		...
		["Material.093"]: THREE.LineBasicMaterial;
...
export function Stage(props: JSX.IntrinsicElements["group"]) {
	const { nodes, materials } = useGLTF("/small_stage.glb") as GLTFResult;
	return (
...
useGLTF.preload("/small_stage.glb");
